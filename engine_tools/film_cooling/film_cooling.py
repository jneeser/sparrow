...
film_massflow = total_massflow * 0.1
fuel_massflow = total_massflow / (1+OF) + film_massflow
...
coolant = thermo.Chemical('C2H5OH', P=65e5, T=370)
film = film.FilmCooling(coolant, cea, 5.8, film_massflow, chamber_pressure, geometry[42,1], geometry)
T_aw_cooled = film.T_aw(film_start=42, film_end=80, mach=mach, T_aw_uncooled=T_aw_uncooled, n_holes=number_of_channels, chamber_pressure=chamber_pressure)[::-1]
